...
def fun_5_9( x, order=0 ):
    ...
    if order == 0:
        ...
        gradient[1,0] = - 2*x2*exp(1 - x1**2 - 20*(x1 - x2)**2) - (x2**2)*exp(1 - x1**2 - 20*(x1 - x2)**2)*(40*x1 - 40*x2)
        return (value, gradient)
    elif order == 2:
        gradient = np.zeros((2,1))
        gradient[0,0] = (x2**2)*exp(1 - x1**2 - 20*(x1 - x2)**2)*(42*x1 - 40*x2)
...
#        gradient = H.dot( x) + b
        hessian = np.zeros((2,2))
        hessian[0,0]=42*x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2) - x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2)*(42*x1 - 40*x2)**2
        hessian[0,1]=2*x2*exp(1 - x1**2 - 20*(x1 - x2)**2)*(42*x1 - 40*x2) - 40*x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2) \
                    + x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2)*(40*x1 - 40*x2)*(42*x1 - 40*x2)
        hessian[1,0]= hessian[0,1]
        hessian[1,1]=40*x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2) - 2*exp(1 - x1**2 - 20*(x1 - x2)**2) \
                    - x2**2*exp(1 - x1**2 - 20*(x1 - x2)**2)*(40*x1 - 40*x2)**2 - 4*x2*exp(1 - x1**2 - 20*(x1 - x2)**2)*(40*x1 - 40*x2)
