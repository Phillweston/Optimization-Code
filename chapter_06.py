...
if __name__ == "__main__":
    ...
    x, values, runtimes, gd_xs= dfp( alg.weird_func, initial_x,0.001, eps, maximum_iterations, backtracking_line_search )
    ...
    x, values, runtimes, gd_xs = dfp( alg_05.fun_5_9, initial_x, 1e-6, maximum_iterations, backtracking_line_search )
    print('Optimum of the fun_5_9 function found by GD with inexact line search', x)
    

    x, values, runtimes, gd_xs = bfgs( alg_05.fun_5_9, initial_x, 1e-6, maximum_iterations, backtracking_line_search )
    print('Optimum of the fun_5_9 function found by GD with inexact line search', x)
